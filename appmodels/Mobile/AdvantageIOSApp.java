...
public class AdvantageIOSApp extends AppModelBase {		private AdvantageShoppingApplication AdvantageShoppingApplication;
	...
	private IshoppingApplication IshoppingApplication;
	...
	public class SPEAKERSLabel extends LabelNodeBase
	{
		...
		protected com.hp.lft.sdk.mobile.LabelDescription createDescription() throws GeneralLeanFtException{
			com.hp.lft.sdk.mobile.LabelDescription description = null; 
			try{
				description = new com.hp.lft.sdk.mobile.LabelDescription.Builder().text("SPEAKERS").accessibilityId("SPEAKERS").className("Label").container("Table[0][3][0]").mobileCenterIndex(0).build();
			}catch(Exception e){
				throw new GeneralLeanFtException(e.getMessage(), e);
			}
			return description;
